...
**[⬇ Download reteclock-0.39.0.apk](https://github.com/rubidus-api/reteclock_apk/releases/download/v0.39.0/reteclock-0.39.0.apk)**
— 500 KB, installs on Android 2.3 and newer. This is the file itself, so an old browser that cannot
...
Published on F-Droid; the latest release is 0.39.0.

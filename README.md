...
**[⬇ Download reteclock-0.8.0.apk](https://github.com/rubidus-api/reteclock_apk/releases/latest/download/reteclock-0.8.0.apk)** — 91 KB, installs on Android 2.3 and newer.
...
Published on F-Droid; the latest release is 0.8.0.
